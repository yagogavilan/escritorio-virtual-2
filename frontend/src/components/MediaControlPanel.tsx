...
export const MediaControlPanel: React.FC<MediaControlPanelProps> = ({
  ...
  return (
    <>
      {/* Ultra Compact View - Integrated in Sidebar */}
      <div className="px-3 py-2 border-b border-slate-200">
        {/* Mini Video Preview */}
        <div className="relative bg-slate-800 rounded-lg overflow-hidden mb-1.5 group cursor-pointer h-20"
        ...
        <div className="flex gap-1">
          <button
            ...
            className={`flex-1 p-1.5 rounded text-[10px] font-semibold flex items-center justify-center gap-0.5 ${
              isMuted
        ...
        {showSettings && (
          <div className="mt-1.5 p-1.5 bg-slate-50 rounded space-y-1.5 animate-in slide-in-from-top-2 fade-in duration-200">
            {/* Microfone */}
            <div>
              <label className="text-slate-500 text-[8px] font-medium mb-0.5 block flex items-center gap-0.5">
                <Mic size={8} />
                Mic
              </label>
              <select
                ...
                className="w-full px-1.5 py-0.5 bg-white border border-slate-200 rounded text-slate-700 text-[9px] focus:outline-none focus:ring-1 focus:ring-indigo-400"
              >
